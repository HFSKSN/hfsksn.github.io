...
My contributions to the project can be reviewed by navigating the datasheet. 
...
* To review the selected microcontroller of the module as well as the rationale behind the selection, navigate to the ["Microcontroller Selection"](https://hfsksn.github.io/04-Microcontroller-Selection/microcontroller/) section of the datasheet.
...
* To review the API created for the module and its files, navigate to the ["PCB"](https://hfsksn.github.io/08-PCB/pcb/) section of the datasheet.
* To review the  created for the module and its files, navigate to the ["PCB"](https://hfsksn.github.io/08-PCB/pcb/) section of the datasheet.
